...
//----------- Start of Viz 411------------------------------------- Start of Viz 411------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point71').on("mouseover", function(d){
			...
			cardImage71.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 412------------------------------------- Start of Viz 412------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point72').on("mouseover", function(d){
			...
			cardImage72.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 413------------------------------------- Start of Viz 413------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point73').on("mouseover", function(d){
			...
			cardImage73.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
// Hover Dialog Box
	    ...
	    d3.selectAll('.point74').on("mouseover", function(d){
			...
			cardImage74.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 415------------------------------------- Start of Viz 415------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point75').on("mouseover", function(d){
			...
			cardImage75.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
	  ...
	  return d;
		  ...
		  // adding color to bars according to degrees of freedom
		    ...
		    d3.selectAll('.point81').on("mouseover", function(d){
				...
				cardImage81.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
	  ...
	  return d;
		  ...
		  // adding color to bars according to degrees of freedom
		    ...
		    d3.selectAll('.point82').on("mouseover", function(d){
				...
				cardImage82.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
	  ...
	  return d;
		  ...
		  // adding color to bars according to degrees of freedom
		    ...
		    d3.selectAll('.point83').on("mouseover", function(d){
				...
				cardImage83.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
	  ...
	  return d;
		  ...
		  // adding color to bars according to degrees of freedom
		    ...
		    d3.selectAll('.point84').on("mouseover", function(d){
				...
				cardImage84.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
	  ...
	  return d;
		  ...
		  // adding color to bars according to degrees of freedom
		    ...
		    d3.selectAll('.point85').on("mouseover", function(d){
				...
				cardImage85.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
