	...
	//----------- Start of of Viz 21------------------------------------- Start  of Viz 21 ------------------------------------
	    ...
	    d3.selectAll('.point3').on("mouseover", function(d){
			...
			cardImage3.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
	...
	//----------- Start of Viz 22------------------------------------- Start of Viz 22------------------------------------
	  ...
	  svg4.append("g")			
	    ...
	    d3.selectAll('.point4').on("mouseover", function(d){
			...
			cardImage4.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
