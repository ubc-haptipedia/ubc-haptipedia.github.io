...
//----------- Start of Viz 321------------------------------------- Start of Viz 321------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point61').on("mouseover", function(d){
			...
			cardImage61.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 322------------------------------------- Start of Viz 322------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point62').on("mouseover", function(d){
			...
			cardImage62.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 323------------------------------------- Start of Viz 323------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point63').on("mouseover", function(d){
			...
			cardImage63.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
// Hover Dialog Box
	    ...
	    d3.selectAll('.point64').on("mouseover", function(d){
			...
			cardImage64.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 325------------------------------------- Start of Viz 325------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point65').on("mouseover", function(d){
			...
			cardImage65.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
...
//----------- Start of Viz 326------------------------------------- Start of Viz 326------------------------------------
	...
	// Hover Dialog Box
	    ...
	    d3.selectAll('.point66').on("mouseover", function(d){
			...
			cardImage66.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
