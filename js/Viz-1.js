	...
	//----------- Start of Viz 11------------------------------------- Start of Viz 11------------------------------------
	  ...
	  svg1.append("g")			
	    ...
	    d3.selectAll('.point').on("mouseover", function(d){
			...
			cardImage1.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
		  ...
		  return d;
			  ...
			  // adding color to bars according to degrees of freedom
			    ...
			    d3.selectAll('.point2').on("mouseover", function(d){
					...
					cardImage2.html('<img class="card-image-tag" src="https://ubc-haptipedia.github.io/' + d.Device + '/Figure1-1.png">')
